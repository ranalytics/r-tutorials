...
#-----------------------------------------------------------------------
#  К разделу 8.1. Модели сглаживания
#-----------------------------------------------------------------------	
...
# для различных значений параметра spar:
...
#-----------------------------------------------------------------------	
#   К разделу  8.3.Модели пробит- и логит-регрессии
#-----------------------------------------------------------------------	
...
#  Определим предварительно три  функции
...
# 3 Возвращает характеристики модели для графика:
...
# Найдем доверительные интервалы коэффициентов:
confint(lm.nogluc)
...
legend("topright", legend=c("без глюкозы","с глюкозой", "для обеих групп"), 
       lwd = c(2,2,1), lty = c(1,1,2), col = c("blue", "green","red"))
...
#-----------------------------------------------------------------------	
# К разделу 8.6. Модели со смешанными эффектами для иерархически организованных данных
#-----------------------------------------------------------------------	
...
#-----------------------------------------------------------------------	
#   К разделу 8.7.	Индуктивные модели (метод группового учета аргументов)
#-----------------------------------------------------------------------	
...
#-----------------------------------------------------------------------	
#   К разделу 8.8.	Моделирование структурными уравнениями 
#-----------------------------------------------------------------------	
